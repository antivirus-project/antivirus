...
namespace AntivirusApp
{
    ...
    public partial class ResultWindow : Window
    {
        ...
        private string virusInfoFile = "virus.txt";
        ...
        public static int maliciousFiles = 0; // 악성 파일 수 (임의의 값)
        ...
        private void Recover_Click(object sender, RoutedEventArgs e)
        {
            ...
            */
            caring.Text = "치료 완료";
            AftercareWindow aftercareWindow = new AftercareWindow();
            aftercareWindow.Show();
            this.Close();
        }
